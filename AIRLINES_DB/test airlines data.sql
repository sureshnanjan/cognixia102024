SELECT
    ...
    CASE
        ...
        WHEN airport_code = 'LAX' AND city_id = 2 AND airport_name = 'Los Angeles International Airport' THEN 'Matched'
        WHEN airport_code = 'YYZ' AND city_id = 3 AND airport_name = 'Toronto Pearson International Airport' THEN 'Matched'
        WHEN airport_code = 'LHR' AND city_id = 4 AND airport_name = 'Heathrow Airport' THEN 'Matched'
