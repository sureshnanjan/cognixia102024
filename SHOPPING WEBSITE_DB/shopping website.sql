...
use shopping;
select 'creating database structure' as 'info2';
drop table if exists supplier,supplier_order,supplier_order_line,product,product_category,brand,color,size,customer_order,customer_order_line,user_account,address,user_address;
