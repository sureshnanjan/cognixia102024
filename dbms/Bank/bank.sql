...
SELECT 'LOADING data into account_type' as 'INFO';
source accountType.dump;

SELECT 'LOADING data into account_status' as 'INFO';
source accountStatus.dump;

SELECT 'LOADING data into customer' as 'INFO';
source customer.dump;

SELECT 'LOADING data into account' as 'INFO';
source account.dump;

SELECT 'LOADING data into customer_account' as 'INFO';
SOURCE customer_account.dump;

SELECT 'LOADING data into transaction' as 'INFO';
